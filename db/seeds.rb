...
Publicacao.create!(titulo: "Photothermal characterization of low density polyethylene food packages",
				   abstract: "The present work discuss the applicability of photothermal techniques for determining diffusion coefficients of 
							   ...
							   of diffused gas by a photoacoustic analyzer. Diffusion coefficients measured for CO2 and O2 were 2.77 x 10-8 cm2/s 
							   and 1.68 x 10-7 cm2/s, respectively. To support the gas diffusion results, thermal properties were studied using 
							   photoacoustic spectroscopy and crystallinity was determined using X-ray diffraction. Values obtained for thermal 
							   diffusivity and specific heat capacity were 1.65 x 10-3cm2/s and 2.33 J.cm-3K-1, which are in good agreement with 
							   values available in the literature for pure LDPE and thus assure reliability of diffusion coefficients values.",
					
					link: "http://www.scielo.br/scielo.php?script=sci_pdf&pid=S0104-14282004000100007&lng=en&nrm=iso&tlng=en"
					)
Publicacao.create!(titulo: "Effects of hydroxyvalerate contents in thermal degradation kinetic of cellulose acetate propionate/poly(3-hydroxyalkanoates) blends", 
				   abstract: "Thermal stability of polymers is an important parameter that determines the application as well as the processing 
				   			  conditions. The green polymers have shown low thermal stability, such as the polyhydroxyalkanoates (PHAs). The PHAs 
				   			  with different comonomers containing hydroxyvalerate (HV) were studied. It was seen that the green polymer showed a 
				   			  fast thermal degradation process. The addition of the HV comonomer modified this profile and the thermal degradation 
				   			  kinetic. The blend prepared between the PHAs and other polymers can modify the thermal degradation process of the 
				   			  green polymers. In the present study, blends of cellulose acetate propionate and PHAs were prepared, and the thermal 
				   			  degradation kinetics of these blends were evaluated. It was observed that the cellulose acetate propionate (CAP) 
				   			  phase in the blends modified the thermal degradation process and kinetic profile of the PHA phase. In the blends, 
				   			  the thermal stability of the PHAs was slightly modified because of CAP reducing the reactivity of the PHAs. On the 
				   			  other hand, the thermal stability of the CAP phase in the blends is not largely modified by the PHA phase. However, 
				   			  the hydroxyvalerate comonomer decreases the reactivity of the CAP phase at the start of thermal degradation of the 
				   			  same. The interaction between the phases promotes the synergetic interaction, which slightly improves the thermal 
				   			  stability of the two polymers blends." , 
				   link: "http://link.springer.com/content/pdf/10.1007%2Fs10973-011-2152-y" 
				  )

Publicacao.create!(titulo: "Mechanical Properties and Abrasive Behavior of Diamond Incorporated Epoxy Composites",
